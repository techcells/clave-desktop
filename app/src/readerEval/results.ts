...
export function serialiseResults(results: EvalResults): string {
  return JSON.stringify({
    ...
    summary: {
       ...
       * no code — this is `results.summary.accepted === true` and nothing else.
       */
      // A strict boolean, built here: `accepted` was the one field of the summary through which a
      // value that is not a boolean — a string — could be copied into the file (review, Minor 6).
