...
- Or Windows 10 version 1903 or later (Windows 11 recommended), which needs no permission. The Windows
...
use the real reader, the real model and the production backend.
